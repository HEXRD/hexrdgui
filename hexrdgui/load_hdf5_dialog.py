...
class LoadHDF5Dialog:
    ...
    def get_HDF4_paths(self, f: str) -> None:
        try:
            ...
            msg = 'ERROR - This installation does not support ' + 'this file type.'
            QMessageBox.warning(self.ui, 'HEXRD', msg)

    def get_HDF5_paths(self, f: str) -> None:
        with h5py.File(f, 'r') as img:
            self.file = img
            img.visit(self.add_path)

    def get_paths(self, f: str) -> None:
    ...
    def results(self) -> tuple[str, str, bool]:

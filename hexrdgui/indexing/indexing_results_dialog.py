...
class IndexingResultsDialog(QObject):
    ...
    def __init__(
        ...
        self.cached_sim_results: dict[tuple[str, int], Any] = {}
    ...
    def show_results_toggled(self) -> None:
        self.update_enable_states()
        self.update_spots()
    ...
    def on_export_grains_clicked(self) -> None:
    ...
    def export_grains(self, filename: str | Path) -> None:
        ...
        if filename.suffix.lower() == '.npz':
            ...
            # Save as txt
            write_grains_txt(grains, str(filename))
    ...
    def setup_grain_id_options(self) -> None:
        w = self.ui.grain_id
    ...
    def setup_hkl_options(self) -> None:
    ...
    @property
    def plane_data(self) -> Any:
        return self.ome_maps.planeData

    @property
    def munged_plane_data(self) -> Any:
    ...
    def simulate_rotation_series(self, hkl_str: str, grain_idx: int) -> dict[str, Any]:
    ...
    def generate_spots_data(self) -> np.ndarray:
    ...
    @property
    def plot_grains_mode(self) -> bool:
        return self._plot_grains_mode

    @plot_grains_mode.setter
    def plot_grains_mode(self, b: bool) -> None:
